package testspringcloud.esclient.controller;

import com.alibaba.fastjson.JSONObject;
import testspringcloud.esclient.entity.EsModel;
import testspringcloud.esclient.entity.EsPage;
import testspringcloud.esclient.utils.ElasticsearchUtil;
...
public class EsController {
    ...
    public String insertJson() {
        ...
        jsonObject.put("id", ldt.format(DateTimeFormatter.ofPattern("yyyyMMddhhmmss")));
        jsonObject.put("age", 25);
        jsonObject.put("name", "j-" + new Random(100).nextInt());
        jsonObject.put("date", new Date());
        String id = ElasticsearchUtil.addData(jsonObject, indexName, jsonObject.getString("id"));
        return id;
    }
    ...
    public String insertModel() {
        ...
        LocalDateTime ldt = LocalDateTime.now();
        esModel.setId(ldt.format(DateTimeFormatter.ofPattern("yyyyMMddhhmmss")));
    ...
    public String update(String id) {
        if (StringUtils.isNotBlank(id)) {
            ...
            jsonObject.put("date", new Date());
            ElasticsearchUtil.updateDataById(jsonObject, indexName, id);
            return "id=" + id;
        } else {
            return "id为空";
        }
    ...
    public String getData(String id) {
        if (StringUtils.isNotBlank(id)) {
            Map<String, Object> map = ElasticsearchUtil.searchDataById(indexName, id, null);
    ...
    public String queryMatchData() {
        ...
        List<Map<String, Object>> list = ElasticsearchUtil.
                searchListData(indexName, boolQuery, 10, "name", null, "name");
    ...
    public String queryWildcardData() {
        ...
        List<Map<String, Object>> list = ElasticsearchUtil.searchListData(indexName, queryBuilder, 10, null, null, null);
        return JSONObject.toJSONString(list);
    }
    ...
    public String queryIntRangeData() {
        ...
        boolQuery.must(QueryBuilders.rangeQuery("age").from(21)
                .to(25));
        List<Map<String, Object>> list = ElasticsearchUtil.searchListData(indexName, boolQuery, 10, null, null, null);
        return JSONObject.toJSONString(list);
    }
    ...
    public String queryPage(String startPage, String pageSize) {
        if (StringUtils.isNotBlank(startPage) && StringUtils.isNotBlank(pageSize)) {
            ...
            boolQuery.must(QueryBuilders.rangeQuery("date").from("2018-04-25T08:33:44.840Z")
                    .to("2019-04-25T10:03:08.081Z"));
            EsPage list = ElasticsearchUtil.searchDataPage(indexName, Integer.parseInt(startPage), Integer.parseInt(pageSize), boolQuery, null, null, null);
            return JSONObject.toJSONString(list);
        } else {
