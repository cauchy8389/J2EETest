...
public class SensitiveWordUtil {
     ...
     */
    public static boolean checkExistence(String txt, int matchType) {
        boolean flag = false;
     ...
     * @return 若包含返回true，否则返回false
     */
    public static boolean checkExistence(String txt) {
        return checkExistence(txt, MaxMatchType);
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        //是否含有关键字
        boolean result = SensitiveWordUtil.checkExistence(string);
        System.out.println(result);

        result = SensitiveWordUtil.checkExistence(string, SensitiveWordUtil.MinMatchTYpe);
        System.out.println(result);
        //该检测时间是init之后的
